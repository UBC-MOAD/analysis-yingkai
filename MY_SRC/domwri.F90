...
!Sep 15: try to add e3 scale factors
!      CALL iom_rstput( 0, 0, inum4, 'e3t', e3t, ktype = jp_i1 )         !    ! e3 scale factors
!      CALL iom_rstput( 0, 0, inum4, 'e3u', e3u, ktype = jp_i1 )
!      CALL iom_rstput( 0, 0, inum4, 'e3v', e3v, ktype = jp_i1 )
!      CALL iom_rstput( 0, 0, inum4, 'e3w', e3w, ktype = jp_i1 )
