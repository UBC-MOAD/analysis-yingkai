MODULE dtadyn
   ...
   USE timing          ! Timing
   USE trcsms_my_trc, ONLY: sornf !  <------ If use build-in dilution
...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: dtadyn.F90 3828 2013-03-06 09:02:01Z cetlod $
...
#endif
      !
      ! If use build-in dilution:
      emp(:, :) = -1.0*emp(:, :)*34.7/(3600.0*24*(hmld(:, :)+1.0e-16)) - sornf
