MODULE daymod
   ...
   !! $Id: daymod.F90 4104 2013-10-22 13:35:12Z smasson $
...
!         IF( nleapy == 1 )   CALL day_mth
      ...
      CALL ymds2ju( nyear, 01, 01, 0.0, zjul)  ! compute julian day of Jan 1 of this year
      inbday= NINT(fjulday - zjul)
      idfday = MOD(inbday, 5)
...
!               IF( nleapy == 1 )   CALL day_mth
         ...
         !
!C         IF(lwp) WRITE(numout,'(a,i8,a,i4.4,a,i2.2,a,i2.2,a,i3.3)') '======>> time-step =', kt,   &
...
!              &   '   nsec_month = ', nsec_month, '   nsec_day = ', nsec_day, '   nsec_week = ', nsec_week
      ...
      IF( nsec_fday > 5*nsecd )   nsec_fday = ndt05     ! New five day
